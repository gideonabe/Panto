...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[90%] mx-auto z-10'>
      ...
      {/* Mobile */}
      <div className='flex md:hidden justify-between items-center w-full text-white pt-4'>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className='md:hidden bg-black/40 text-white mt-2 rounded-lg w-[90%] mx-auto p-6 space-y-4 backdrop-blur-sm absolute z-20'>
